...
namespace WoodWorking.Data.Migrations
{
    ...
    [Migration("20230623193014_addMaterialAndUserMaterialTables")]
    partial class addMaterialAndUserMaterialTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WoodWorking.Data.Models.IdentityUserMaterial", b =>
                {
                    ...
                    b.HasKey("StoreId", "MaterialId");

                    b.HasIndex("MaterialId");

                    b.ToTable("IdentityUserMaterials");
                });
            ...
            modelBuilder.Entity("WoodWorking.Data.Models.Material", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ANPF = "991129------------------------------------------------------------------------------------------------",
                            ImageUrl = "",
                            Name = "ПДЧ ДЪБ КАФЕ ЛАМИНИРАНО 2800/2070/18ММ",
                            Price = 17.84m
                        },
                        new
                        {
            ...
            modelBuilder.Entity("WoodWorking.Data.Models.IdentityUserMaterial", b =>
                {
                    b.HasOne("WoodWorking.Data.Models.Material", "Material")
                        .WithMany()
                        .HasForeignKey("MaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Store")
                        .WithMany()
